...
<div class="contain">
        ...
        <div class="tip_img">
        <img src="${pageContext.request.contextPath}/static/images/wap_yzm/pay_right.png" style="float:left;" /><span style="float:left; margin:0px 0px 0px 10px; height:60px; line-height:60px;">购买成功</span>
        </div>
        <div class="clr"></div>
        <div class="buy_ctn">
          <dl>
