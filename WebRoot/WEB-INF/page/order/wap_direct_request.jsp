...
<div id="MENU">
       <span  class="p_l">
	   <a href="${wholeRetUrl}" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','${pageContext.request.contextPath}/static/images/wap_direct/back2.jpg',1)">
	   <img src="${pageContext.request.contextPath}/static/images/wap_direct/back1.jpg" name="Image1" width="48" height="38" border="0" id="Image1" /></a>
	   </span>
       <span><b>确认支付</b></span>
</div>
<div id="logod" class="t_l"><img src="${pageContext.request.contextPath}/static/images/wap_direct/logo.jpg"  class="ml10"/></div>
<div id="MAIN">
<form method="post" action="${pageContext.request.contextPath}/pay/wapDirectCaptcha.do" name="hfForm">
  ...
  <div class="maininfo">
		  ...
		  <div class="box mt10 mbt10">
		    ...
		    <div class="pt10"> 
				...
				<ul>
				<li class="t_l">支付手机号</li>
				<li class="t_l">
				   <input type="text" name="mobileId" value="${mobileId}" class="inputa"  maxlength="11"/>
				   <c:if test="${retCode != '0000'}">
				   		<div class="mt10"  id="ERROR"><p class="ml10">${retMsg}</p></div>
				   </c:if>
				</li>
				<li class="t_l"><input type="submit" value="下一步" class="buttona mt10 mbt10" /></li>
				</ul>
