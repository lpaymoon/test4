...
<script type="text/javascript"
	src="<c:url value='/static/js/forward.js'/>"></script>
<script type="text/javascript">   
...
<div class="cz_bg">
	<div class="head">
		充值流程咨询电话：400-612-5880<br />
    	毒霸产品咨询电话：400-610-7777
    </div>
	<div class="czmain">
		<div class="czm yd">
			<p class="czm4">
			...
			<div class="cz8" id="help" style="display: none">
				...
				（只支持移动手机，0.3元/分，无长途话费）有短信签名功能的手机，请在回复前去掉<br />
				签名的自动附加功能，以免回复信息系统无法识别拒绝支付
		    </div>
	...
	<div class="cz3"><a href="http://pcsafe.shop.kingsoft.com/dp.php?passport=" target="_blank">每月18元 = 毒霸 + 5000 元电脑硬件保险</a></div>
</div>
</body>
</html>