...
<body>
<form method="post" action="${pageContext.request.contextPath}/wap/wapVerifyCode.do" id="hfForm" name="hfForm">
<div class="contain">
  ...
  <div class="ctn_txt">
    ...
    <dl class="ctn_nr">
      ...
      <dt>支付手机：<input name="mobileId"  style="width:120px;" type="text" value="${order.mobileId }" /></dt>
      <c:if test="${retCode != '0000'}">
        <dt><span class="cor_red">${retMsg}</span></dt>
      </c:if>
    </dl>
  </div>
