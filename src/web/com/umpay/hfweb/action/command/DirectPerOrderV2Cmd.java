 ...
 * ***********************************************
 */
public class DirectPerOrderV2Cmd extends DirectOrderCmd{
	
	private String funCode;
	private String rdpwd;
	private String remark;
	
	public DirectPerOrderV2Cmd(Map<String,Object> reqMap) {
		...
		this.orderId = ObjectUtil.trim(reqMap.get(DataDict.MER_REQ_ORDERID_V2));
	...
	public String getPlainText(){
		...
		buffer.append("&ORDERID=").append(this.getOrderId());
