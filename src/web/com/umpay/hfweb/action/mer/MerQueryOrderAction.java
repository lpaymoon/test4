...
/**
 * ******************  类说明  *********************
 * class       :  MerQueryOrderAction
 * @author     :  zhubin
 * @version    :  1.0  
 * description :  商户查询订单                      
 * ***********************************************
 */
public class MerQueryOrderAction extends DirectCommonAction{

	@Override
	protected String getFunCode() {
		return DataDict.FUNCODE_MER_QUERY_ORDER;
	}
...
//		String version = ObjectUtil.trim(requestMsg.get(DataDict.MER_REQ_VERSION));
		...
		if("0".equals(orderState)){
			//do nothing
		}else if("2".equals(orderState)&&payRetCode.equals("0000")){//0000 计费成功
			orderState = "1";
		}else{
			orderState = "-1";
		}
