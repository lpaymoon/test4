...
import com.umpay.hfweb.action.command.DirectPerOrderV2Cmd;
...
/**
 * ******************  类说明  *********************
 * class       :  DirectPayPerV2Action
 * @author     :  yangwr
 * @version    :  1.0  
 * description :  全网按次下单 V2.0
 * @see        :                        
 * ***********************************************
 */
public class DirectPayPerV2Action extends DirectPayAction{
	@Override
	protected String getFunCode() {
		return DataDict.FUNCODE_DIRECT_HTXD_MWPER_V2;
	}
	protected  DirectOrderCmd populateCommand(RequestMsg requestMsg){
		return new DirectPerOrderV2Cmd(requestMsg.getWrappedMap());
	}
