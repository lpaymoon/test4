...
/** ******************  类说明  *********************
 * class       :  ChnlOrderPayAction
 * @author     :  panxingwu
 * @version    :  1.0  
 * description :  渠道下单
 * @see        :                        
 * ************************************************/   
public class ChnlOrderAction extends DirectBaseAction{
	...
	protected void processBussiness(RequestMsg requestMsg,
		...
		logInfo("渠道验签通过");
		requestMsg.put(HFBusiDict.BUSINESSTYPE, DataDict.BUSI_QUDAO_WEB);//业务区分：渠道下单  panxingwu add
		MpspMessage payResp = tradeService.qdOrderCreate(requestMsg);
