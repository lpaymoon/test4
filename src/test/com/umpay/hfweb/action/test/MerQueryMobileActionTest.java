...
import com.umpay.hfweb.action.mer.MerQueryOrderAction;
...
public class MerQueryMobileActionTest{
	private MerQueryOrderAction action = null;
	...
	public void init(){
	    ...
	    action = (MerQueryOrderAction)ctx.getBean("merQueryOrderAction");
	}
	//@Test
	...
	@Test
	public void testMerQueryMobileAction(){
